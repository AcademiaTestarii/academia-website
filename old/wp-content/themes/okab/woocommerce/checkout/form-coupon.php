...
?>
<form class="checkout_coupon form-small form  box coupon-box hide" method="post" style="display:none">
	<div class="ok-row">
		...
		<div class="ok-md-6 ok-xsd-12">
			<div class="form-row form-row-last">
				<input type="submit" class="button dima-button small fill" name="apply_coupon"
