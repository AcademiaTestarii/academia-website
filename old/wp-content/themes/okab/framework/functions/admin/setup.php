 ...
 * WP 4.8
 */
if ( dima_helper::dima_wp_version_check( 4.8 ) ) {
	if ( DIMA_SHORTCODES_IS_ACTIVE && ! is_admin() ) {
		add_action( 'init', 'dima_remove_media_element', 10 );
	}

	function dima_remove_media_element() {
