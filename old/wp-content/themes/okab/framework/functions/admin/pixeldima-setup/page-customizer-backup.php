	...
	if ( ! isset( $_POST['export'] ) ) {
		...
		<div class="inside">
			...
			<form method="post">
				...
				<p><?php esc_html_e( 'Clicking the button below will create a JSON file that contain all customizer settings.','okab') ?></p>
				<p class="submit">
					<input type="submit" name="export" class="button button-primary" value="<?php esc_html_e('Download json File','okab') ?>">
				</p>
			</form>
		</div>
		<?php
