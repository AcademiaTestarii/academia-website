...
function dima_register_theme_customizer_options( $wp_customize ) {
	...
	$DIMA['sections'][] = array( 'dima_customizer_section_amp', esc_html__( 'AMP', 'okab' ), 150, '' );
	...
	$DIMA['controls'][] = array(
		...
		'dima_customizer_section_navbar_topbar',
		wp_kses( __( 'For more details see <a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank" rel="noopener">Formatting Date and Time</a>', 'okab' ), $allowed_tags )
	);
	...
	if ( DIMA_AMP_IS_ACTIVE ) {
		...
		$DIMA['controls'][] = array(
			'dima_amp_logo',
			'image',
			esc_html__( 'Upload Your AMP Logo', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
		...
		$DIMA['controls'][] = array(
			...
			'text',
			esc_html__( 'Facebook App ID', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
		...
		$DIMA['controls'][] = array(
			...
			'radio_button_set',
			esc_html__( 'Back to top button', 'okab' ),
			'dima_customizer_section_amp',
			$Choices_on_off,
			''
		);
		...
		$DIMA['controls'][] = array(
			...
			'image',
			esc_html__( 'Footer Logo Image', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
		...
		$DIMA['controls'][] = array(
			'dima_amp_footer_content_text',
			'textarea',
			esc_html__( 'Copyright Text', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
		...
		$DIMA['controls'][] = array(
			'dima_amp_ad_abover',
			'textarea',
			esc_html__( 'Advertisement Above Content', 'okab' ),
			'dima_customizer_section_amp',
			sprintf( wp_kses_post( __( 'Enter your Ad code, AMP pages support &lt;amp-ad&gt; tag only, <a href="%s" target="_blank">Click Here</a> For More info.', 'okab' ) ), 'https://www.ampproject.org/docs/reference/extended/amp-ad.html' )
		);
		$DIMA['settings'][] = array( 'dima_amp_ad_below', 'refresh', 'dima_return_false' );
		$DIMA['controls'][] = array(
			'dima_amp_ad_below',
			'textarea',
			esc_html__( 'Advertisement Below Content', 'okab' ),
			'dima_customizer_section_amp',
			sprintf( wp_kses_post( __( 'Enter your Ad code, AMP pages support &lt;amp-ad&gt; tag only, <a href="%s" target="_blank">Click Here</a> For More info.', 'okab' ) ), 'https://www.ampproject.org/docs/reference/extended/amp-ad.html' )
		);
		...
		$DIMA['controls'][] = array(
			'dima_amp_bg_color',
			'color-alpha',
			esc_html__( 'Background Color', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
		...
		$DIMA['controls'][] = array(
			...
			'color-alpha',
			esc_html__( 'Header Background Color', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
		...
		$DIMA['controls'][] = array(
			'dima_amp_title_bg_color',
			'color-alpha',
			esc_html__( 'Post meta Color', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
		...
		$DIMA['controls'][] = array(
			...
			'color-alpha',
			esc_html__( 'Footer border color', 'okab' ),
			'dima_customizer_section_amp',
			''
		);
	}
	...
	if ( ! function_exists( 'has_site_icon' ) || ! has_site_icon() ) {
		...
		$DIMA['controls'][] = array(
			...
			wp_kses( __( 'There are many favicon generators available online, such as  <a href="http://www.convertico.com/" target="_blank" rel="noopener" title="Convertico">Convertico</a> and <a href="http://www.favicon.co.uk/" target="_blank" rel="noopener" title="Favicon.co.uk">Favicon.co.uk</a>.', 'okab' ), $allowed_tags )
		);
	}
