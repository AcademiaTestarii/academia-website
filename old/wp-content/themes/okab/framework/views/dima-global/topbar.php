        ...
        <div class="<?php echo esc_attr( $full_width_class ); ?>">
            <ul class="float-start text-start dima-menu">
				...
				<?php if ( $adr_show && $adr_string != '' ) { ?>
                    <li><i class="fa fa-map-marker"></i><?php echo wp_kses( $adr_string, $dima_allowed_HTML_tags ); ?>
                    </li>
				<?php } ?>
				<?php if ( $tel_show && $tel_string != '' ) { ?>
                    <li><i class="fa fa-phone"></i><?php echo wp_kses( $tel_string, $dima_allowed_HTML_tags ); ?>
                    </li>
				<?php } ?>
            </ul>
            ...
            <ul class="float-end text-end dima-menu <?php echo esc_attr( $class ); ?>">
                ...
                <?php if ( is_user_logged_in() ) { ?>
                    <li><a href="<?php echo wp_logout_url(); ?>"><i class="fa fa-user"> </i>Logout</a>
                    </li>
               <?php } ?>
            </ul>
        </div>
