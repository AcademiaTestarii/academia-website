...
function add_custom_meta_boxes() {
	...
	add_meta_box('wp_custom_attachment7', 'Tema 1 PDF', 'wp_custom_attachment7', 'module', 'normal', 'high');
	add_meta_box('wp_custom_attachment8', 'Tema 2 PDF', 'wp_custom_attachment8', 'module', 'normal', 'high');
	add_meta_box('wp_custom_attachment9', 'Tema 3 PDF', 'wp_custom_attachment9', 'module', 'normal', 'high');
	add_meta_box('wp_custom_attachment10', 'Tema 4 PDF', 'wp_custom_attachment10', 'module', 'normal', 'high');
	add_meta_box('wp_custom_attachment11', 'Tema 5 PDF', 'wp_custom_attachment11', 'module', 'normal', 'high');
	add_meta_box('wp_custom_attachment12', 'Tema 6 PDF', 'wp_custom_attachment12', 'module', 'normal', 'high');
...
function cheama_admin() {
	add_menu_page('Cursuri', 'Cursuri', 'manage_options', 'oameni_inscrisi', 'oameni_inscrisi');
	add_menu_page('Studenti', 'Studenti', 'manage_options', 'studenti', 'studenti');
}
...
function studenti() {
	 $file = plugin_dir_path( __FILE__ ) . "studenti.php";
