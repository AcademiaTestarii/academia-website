												...
												foreach ($perioade as $perioada) {
													if($perioada !== 'în curând') {
														...
														if(15 -  ($rowcount - $rowcount2) > 0 ) {
															?>
															<ul class="icon-list">
																<li><a href="http://academiatestarii.ro/index.php/formular/" class="dima-button  dima-btn-rounded fill dima-btn-small"><?php echo $perioada; ?> - Locuri: <?php echo 15 -  ($rowcount - $rowcount2);?></a></li>
															</ul>
												  		<?php } 
													} 
												}; ?>
