...
//slug - wpsai
define('WP_ADSENSE_INSERT_PLUGIN_VERSION', '2.0');
...
?>
	...
	<div class="wrap">
	    ...
	    <textarea name="wp_in_article_ad_code" rows="6" cols="50"><?php echo get_option( 'wp_in_article_ad_code' ); ?></textarea>
	    </td></tr>
	    ...
	    <textarea name="wp_post_article_ad_code" rows="6" cols="50"><?php echo get_option( 'wp_post_article_ad_code' ); ?></textarea>
	    </td></tr>
