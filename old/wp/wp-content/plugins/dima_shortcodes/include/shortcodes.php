...
function dima_shortcode_author( $atts ) {
	...
	$facebook_output   = ( $facebook ) ? "<li><a href=\"{$facebook}\"  title=\"" . esc_attr__( 'Visit the Facebook Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-facebook\"></i></a></li>" : '';
	$twitter_output    = ( $twitter ) ? "<li><a href=\"{$twitter}\"  title=\"" . esc_attr__( 'Visit the Twitter Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-twitter\"></i></a></li>" : '';
	$googleplus_output = ( $googleplus ) ? "<li><a href=\"{$googleplus}\"  title=\"" . esc_attr__( 'Visit the Google+ Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-google-plus\"></i></a></li>" : '';
	$instagram_output  = ( $instagram ) ? "<li><a href=\"{$instagram}\"  title=\"" . esc_attr__( 'Visit the instagram Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-instagram\"></i></a></li>" : '';
	$linkedin_output   = ( $linkedin ) ? "<li><a href=\"{$linkedin}\"  title=\"" . esc_attr__( 'Visit the linkedin Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-linkedin\"></i></a></li>" : '';
	$flickr_output     = ( $flickr ) ? "<li><a href=\"{$flickr}\"  title=\"" . esc_attr__( 'Visit the flickr Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-flickr\"></i></a></li>" : '';
	$youtube_output    = ( $youtube ) ? "<li><a href=\"{$youtube}\"  title=\"" . esc_attr__( 'Visit the youtube Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-youtube\"></i></a></li>" : '';
	$pinterest_output  = ( $pinterest ) ? "<li><a href=\"{$pinterest}\"  title=\"" . esc_attr__( 'Visit the pinterest Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-pinterest\"></i></a></li>" : '';
	$behance_output    = ( $behance ) ? "<li><a href=\"{$behance}\"  title=\"" . esc_attr__( 'Visit the behance Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-behance\"></i></a></li>" : '';
	$dribbble_output   = ( $dribbble ) ? "<li><a href=\"{$dribbble}\"  title=\"" . esc_attr__( 'Visit the dribbble Profile for', 'okab' ) . " {$display_name}\" target=\"_blank\"><i class=\"fa fa-dribbble\"></i></a></li>" : '';
...
function dima_shortcode_share_post( $atts ) {
	...
	$vk          = ( $vk == 'true' ) ? "<li><a href=\"#share\" {$tooltip_attr} title=\"" . __( 'Share on Vk', 'dimashortcodes' ) . "\" onclick=\"window.open('http://vk.com/share.php?url={$share_url}&amp;title={$share_title}&amp;description={$share_content}', 'popupVk', 'width=875, height=450, resizable=0, toolbar=0, menubar=0, status=0, location=0, scrollbars=0'); return false;\"><i class=\"fa fa-vk\"></i></a></li>" : '';
	...
	$output = "<div {$id} class=\"{$class}{$float}\" {$style}>"
	          ...
	          . "<ul class=\"inline clearfix\">"
	          . $facebook . $twitter . $google_plus . $linkedin . $vk . $pinterest . $reddit . $email
	          . "</ul>"
	          . "</div>"
	          . "</div>";
...
if ( ! function_exists( 'dima_add_contact_methods' ) ) :
	function dima_add_contact_methods( $user_contactmethods ) {
		...
		$user_contactmethods['flickr']    = esc_html__( 'Flickr Profile', 'okab' );
		$user_contactmethods['youtube']   = esc_html__( 'YouTube Profile', 'okab' );
		$user_contactmethods['pinterest'] = esc_html__( 'Pinterest Profile', 'okab' );
		$user_contactmethods['behance']   = esc_html__( 'Behance Profile', 'okab' );
		$user_contactmethods['dribbble']  = esc_html__( 'Dribbble Profile', 'okab' );
