...
function dima_vc_add_setting_fields( $vc_config ) {
	...
	$vc_config->addField( $tab, esc_html__( 'Visual Composer Integration', 'dima-noor' ), 'dima_vc_int', 'dima_vc_sanitize_checkbox', 'dima_vc_dima_vc_int' );
...
function dima_vc_dima_vc_int() {
	return dima_vc_options( 'dima_vc_int', false, esc_html__( 'Enable', 'dima-noor' ), esc_html__( 'To be able to use All Visual Composer elemnts you need to turn the Visual Composer Integration on.', 'dima-noor' ) );
}
