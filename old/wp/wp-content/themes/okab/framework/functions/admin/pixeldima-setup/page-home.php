		...
		<div class="changelog">
			<div class="feature-section">
				...
				<div class="three">
					...
					<p><?php echo wp_kses( __( 'Our <a href="http://pixeldima.com/knowledgebase/" target="_blank" rel="noopener">Knowledge Base</a> include more specific and unique information for the theme.', 'okab' ), $dima_allowed_HTML_tags ); ?></p>
				...
				<div class="three">
					...
					<a href="http://pixeldima.com/forums/" target="_blank" rel="noopener"
				...
				<div class="three">
					...
					<p><?php echo wp_kses( __( 'We strive to give our customers excellent support through our ticket system. Make sure to register your purchase at <a href="http://pixeldima.com/support/" target="_blank" rel="noopener">support page</a>  to access our support services.', 'okab' ), $dima_allowed_HTML_tags ); ?></p>
