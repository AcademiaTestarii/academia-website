...
if ( ! class_exists( 'dima_get_googlefonts_name' ) ) {
	...
	/**
	 * [ Get The Font Name ]
	 * @return [array] [Get font ditails by font name ]
	 */
...
function dima_get_font_subsets() {
	$dima_list_font_subsets = array(
		'arabic'       => esc_html__( 'Arabic', 'okab' ),
		'latin'        => esc_html__( 'Latin', 'okab' ),
		'latin-ext'    => esc_html__( 'Latin Extended ', 'okab' ),
		'vietnamese'   => esc_html__( 'vietnamese', 'okab' ),
		'greek'        => esc_html__( 'Greek', 'okab' ),
		'greek-ext'    => esc_html__( 'Greek Extended ', 'okab' ),
		'cyrillic'     => esc_html__( 'Cyrillic', 'okab' ),
		'cyrillic-ext' => esc_html__( 'Cyrillic Extended ', 'okab' ),
	);
