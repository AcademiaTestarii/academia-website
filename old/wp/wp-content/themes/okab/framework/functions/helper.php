...
if ( ! class_exists( 'dima_helper' ) ) {
	class dima_helper {
		...
		static function dima_is_portfolio_home_page() {
			GLOBAL $post;
			if ( $post->post_type == 'dima-portfolio' && ! is_singular( 'dima-portfolio' ) && DIMA_SHORTCODES_IS_ACTIVE ) {
				return true;
			} else {
				return false;
			}
...
if ( ! function_exists( 'dima_get_global_social' ) ) :
	...
	function dima_get_global_social( $colored = false ) {
		...
		$vk          = dima_helper::dima_get_option( 'dima_social_vk' );
		...
		$facebook_color = $twitter_color = $google_plus_color
			...
			= $flickr_color = $behance_color = $rss_color = $tumblr_color = $vk_color = $whatsapp_color = $soundcloud_color
			= '';
		if ( $colored ) {
			...
			if ( $vk )    : $vk_color = 'class="vk"';endif;
		}
		if ( $facebook )    : $output .= '<li ' . $facebook_color . '><a href="' . esc_url( $facebook ) . '" title="Facebook" target="_blank" rel="noopener"><i class="fa fa-facebook"></i></a></li>'; endif;
		if ( $twitter )     : $output .= '<li ' . $twitter_color . '><a href="' . esc_url( $twitter ) . '" title="Twitter" target="_blank" rel="noopener"><i class="fa fa-twitter"></i></a></li>'; endif;
		if ( $google_plus ) : $output .= '<li ' . $google_plus_color . '><a href="' . esc_url( $google_plus ) . '" title="Google+" target="_blank" rel="noopener"><i class="fa fa-google-plus"></i></a></li>'; endif;
		if ( $linkedin )    : $output .= '<li ' . $linkedin_color . '><a href="' . esc_url( $linkedin ) . '" title="LinkedIn" target="_blank" rel="noopener"><i class="fa fa-linkedin"></i></a></li>'; endif;
		if ( $foursquare )  : $output .= '<li ' . $foursquare_color . '><a href="' . esc_url( $foursquare ) . '" title="Foursquare" target="_blank" rel="noopener"><i class="fa fa-foursquare"></i></a></li>'; endif;
		if ( $youtube )     : $output .= '<li ' . $youtube_color . '><a href="' . esc_url( $youtube ) . '" title="YouTube" target="_blank" rel="noopener"><i class="fa fa-youtube"></i></a></li>'; endif;
		if ( $vimeo )       : $output .= '<li ' . $vimeo_color . '><a href="' . esc_url( $vimeo ) . '" title="Vimeo" target="_blank" rel="noopener"><i class="fa fa-vimeo"></i></a></li>'; endif;
		if ( $instagram )   : $output .= '<li ' . $instagram_color . '><a href="' . esc_url( $instagram ) . '" title="Instagram" target="_blank" rel="noopener"><i class="fa fa-instagram"></i></a></li>'; endif;
		if ( $pinterest )   : $output .= '<li ' . $pinterest_color . '><a href="' . esc_url( $pinterest ) . '" title="Pinterest" target="_blank" rel="noopener"><i class="fa fa-pinterest"></i></a></li>'; endif;
		if ( $dribbble )    : $output .= '<li ' . $dribbble_color . '><a href="' . esc_url( $dribbble ) . '" title="Dribbble" target="_blank" rel="noopener"><i class="fa fa-dribbble"></i></a></li>'; endif;
		if ( $flickr )      : $output .= '<li ' . $flickr_color . '><a href="' . esc_url( $flickr ) . '" title="Flickr" target="_blank" rel="noopener"><i class="fa fa-flickr"></i></a></li>'; endif;
		if ( $behance )     : $output .= '<li ' . $behance_color . '><a href="' . esc_url( $behance ) . '" title="Behance" target="_blank" rel="noopener"><i class="fa fa-behance"></i></a></li>'; endif;
		if ( $tumblr )      : $output .= '<li ' . $tumblr_color . '><a href="' . esc_url( $tumblr ) . '" title="Tumblr" target="_blank" rel="noopener"><i class="fa fa-tumblr"></i></a></li>'; endif;
		if ( $whatsapp )    : $output .= '<li ' . $whatsapp_color . '><a href="' . esc_url( $whatsapp ) . '" title="Whatsapp" target="_blank" rel="noopener"><i class="fa fa-whatsapp"></i></a></li>'; endif;
		if ( $soundcloud )  : $output .= '<li ' . $soundcloud_color . '><a href="' . esc_url( $soundcloud ) . '" title="SoundCloud" target="_blank" rel="noopener"><i class="fa fa-soundcloud"></i></a></li>'; endif;
		if ( $rss )         : $output .= '<li ' . $rss_color . '><a href="' . esc_url( $rss ) . '" title="RSS" target="_blank" rel="noopener"><i class="fa fa-rss"></i></a></li>'; endif;
		if ( $vk )          : $output .= '<li ' . $vk_color . '><a href="' . esc_url( $vk ) . '" title="VK" target="_blank" rel="noopener"><i class="fa fa-vk"></i></a></li>'; endif;
...
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'dima_get_rgb_color' ) ) {

	function dima_get_rgb_color( $hex, $array = false ) {
...
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'dima_light_or_dark' ) ) {

	function dima_light_or_dark( $color, $return_rgb = false, $dark = '#000000', $light = '#FFFFFF' ) {

		$rgb = dima_get_rgb_color( $color, true );
		extract( $rgb );

		$brightness = ( ( $r * 299 ) + ( $g * 587 ) + ( $b * 114 ) ) / 1000;
		$color      = $brightness > 200 ? $dark : $light;

		return $return_rgb ? dima_get_rgb_color( $color ) : $color;
	}
