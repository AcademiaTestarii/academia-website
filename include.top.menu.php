    ...
    <div class="header-nav-wrapper navbar-scrolltofixed">
        <div class="container">
            <nav id="menuzord-right" class="menuzord yellow ">
                <a class="menuzord-brand pull-left flip" href="index.php"><img src="images/logo-academia-testarii.png"
                                                                               alt=""></a>
                <ul class="menuzord-menu">
                    ...
                    <li <?php if ($page == "home") {
                        ...
                        echo 'class="home"><a href="index.php">';
                    } ?><i class="fa fa-home"></i></a></li>

                    <li <?php if ($page == "despre") {
                        echo 'class="active"';
                    } ?>><a href="despre-noi.php">Despre noi</a></li>

                    <li <?php if ($page == "cursuri") {
                        echo 'class="active"';
                    } ?>><a href="cursuri.php">Cursuri pentru tine </a>
                        <ul class="dropdown">
                            <?php
...
ORDER BY `main_classes`.`order` ASC";
                            ...
                            while ($row_cursuri = mysqli_fetch_assoc($query_cursuri)) {
                                ?>
                                <li><a href="curs.php?id=<?php echo $row_cursuri['id']; ?>">
                    ...
                    <li <?php if ($page == "firme") {
                        echo 'class="active"';
                    } ?>><a href="pentru-companii.php">Servicii pentru Companii</a></li>
