        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="search_results.php">
                <div class="form-group">
                    <input type="text" placeholder="Cauta ..." class="form-control" name="top-search" id="top-search">
                </div>
            </form>
        </div>
                            ...
                            <div class="search-form">
                                <form action="dashboard.php" method="get">
                                    <div class="input-group">
                                        <input type="text" placeholder="Academia Testarii" name="search" class="form-control input-lg">
