...
// Restaurare factura
echo 'Restaurare factura: ';
try {
    $sbcClient->restoreInvoice($companyVatCode, $companyInvoiceSeries, $invoiceNumber);
    echo $message = $output['message'];
} catch (Exception $ex) {
    echo $ex->getMessage();
}
// Restaurare factura: Factura cu seria si numarul F0194 a fost anulata cu succes. -> cu mesaj de succes
// Restaurare factura: Factura cu seria si numarul F1111 nu a fost gasita! -> cu mesaj de eroare
