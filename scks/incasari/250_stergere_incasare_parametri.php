...
// Stergere incasare (dupa parametrii identificare)
$payment = array(
    'companyVatCode'=> $companyVatCode,
    'paymentType'   => SmartBillCloudRestClient::PaymentType_Card,
    'paymentDate'   => date('Y-m-d'),
    'paymentValue'  => 20,
    'clientName'    => "Intelligent IT",
    'clientCif'     => "RO12345678",
);
echo 'Stergere incasare dupa parametrii identificare: ';
try {
    $output = $sbcClient->deletePayment($payment);
