...
echo 'Vizualizare proforma in: ';
$file = __DIR__ . DIRECTORY_SEPARATOR . 'proforma.pdf';
try {
    $pdf = $sbcClient->PDFProforma($companyVatCode, $estimateSeries, $estimateNumber); // file is saved in the specified file
    if ( !empty($pdf) ) {
