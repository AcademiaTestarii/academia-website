                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="mt-0 text-theme-colored">Bine ai venit in contul tău <span
                                        class="text-theme-colored2"><?php echo $row['first_name']; ?></span>.</h2>
                            <p>Oferim cursuri de pregătire specializată în testare software, consultanță și servicii de
                                resurse.</p>
                            <p>Conectat la cele mai recente tendințe, practici, tehnologii și industrie instrumente,
                                avem o vastă experiență în zonă, adunate prin aplicare practică în procesul de
                                dezvoltare timp de aproape 20 de ani.</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="job-overview">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                        ...
                                        <p><?php echo strftime("%e %B, %Y", strtotime($row['registration_date'])); ?></p>
                                    </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                        ...
                                        <p><?php if ($row['activity'] != NULL) {
                                                echo strftime("%e %B, %Y <br> %H:%M:%S", strtotime($row['activity']));
                                            } else {
                                                echo "Astazi";
                                            } ?></p>
                                    </dd>
                                ...
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                        ...
                                        <p><a href="javascript:void()" data-toggle="modal"
                                              data-target=".bs-example-modal-lg"><i class="fa fa-link"></i> Termeni si
                                                condiții</a></p>
                        ...
                        <div class="col-md-9">
                            <div class="icon-box mb-0 p-0">
                                ...
                                <div class="panel-group accordion-theme-colored accordion-icon-right" id="accordion16"
                                     role="tablist">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-xs-12 curs">
                                                        <ul id="myTab" class="nav nav-tabs boot-tabs">
                                                            <li class="active"><a href="#active" data-toggle="tab">Cursuri
                                                                    active</a></li>
                                                            <li><a href="#inactive" data-toggle="tab">Cursuri
                                                                    absolvite</a></li>
                                                        </ul>
                                                                ...
                                                                while ($row_curs_activ = mysqli_fetch_assoc($sql_cursuri_active)) {
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <p><strong>Data
                                                                                    înscriere: </strong> <?php echo strftime("%e %B %Y la %H:%M:%S", strtotime($row_curs_activ['registration_start_date'])); ?>
                                                                                <br/>
                                                                                <strong>Cursul începe
                                                                                    pe: </strong> <?php echo strftime("%e %B %Y", strtotime($datesRowactiv['start1'])); ?>
                                                                                <br/>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <?php if ($row_curs_activ['schedule_pdf'] != "") { ?>
                                                                                <a href="<?php echo $crmHost; ?>/documents/<?php echo $row_curs_activ['schedule_pdf']; ?>"
                                                                                   target="_blank"
                                                                                   class="btn btn-gray btn-transparent btn-xs">Programa
                                                                                    curs</a>
                                                                            <?php } ?>
                                                                            ...
                                                                            <?php if ($row_curs_activ['requirements_description'] != "") { ?>
                                                                                | <a href="javascript:void()"
                                                                                     ...
                                                                                     class="btn btn-gray btn-transparent btn-xs">Conditii
                                                                                    participare</a>
                                                                ...
                                                                while ($row_curs_inactiv = mysqli_fetch_assoc($sql_cursuri_inactive)) {
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <p><strong>Data
                                                                                    înscriere: </strong> <?php echo strftime("%e %B %Y la %H:%M:%S", strtotime($row_curs_inactiv['registration_start_date'])); ?>
                                                                                <br/>
                                                                                <strong>Cursul începe
                                                                                    pe: </strong> <?php echo strftime("%e %B %Y", strtotime($datesRowinactiv['start2'])); ?>
                                                                                <br/>
                                                                                <strong>Preț
                                                                                    curs: </strong> <?php echo number_format($row_curs_inactiv['price']); ?>
                                                                                Lei
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            if (mysqli_num_rows($query_feedback) > 0) {
                                                                                ...
                                                                                <a href="feedback.php?id=<?php echo $row_feedback['link']; ?>"
                                                                                   target="_blank"
                                                                                   class="btn btn-gray btn-transparent btn-xs">Feedback
                                                                                    curs</a>
                                                                                |
                                                                                <a href="certificat.php?id=<?php echo $row_feedback['link']; ?>"
                                                                                   target="_blank"
                                                                                   class="btn btn-gray btn-transparent btn-xs">Certificat
                                                                                    de ablosvire curs</a>
                                                                            <?php } ?>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form id="profil" name="profil" class="reservation-form"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group mb-30"><label>Data
                                                                        naștere</label>
                                                                    <input placeholder="Data naștere" id="data_nastere"
                                                                           name="data_nastere" required=""
                                                                           class="form-control" aria-required="true"
                                                                           type="date"
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group mb-30"><label>Localitate</label>
                                                                    <input placeholder="O folosim pentru factură"
                                                                           id="localitate" name="localitate" required=""
                                                                           class="form-control" aria-required="true"
                                                                           type="text"
                                            ...
                                            <div class="panel-heading" role="tab" id="headingPreferinte">
                                                <h6 class="panel-title">
                                                    <a class="collapsed" role="button" data-toggle="collapse"
                                                       ...
                                                       aria-expanded="false" aria-controls="sectiuneaParola">Schimbă
                                                        parola</a>
                                                </h6>
                                            </div>
                                            <div id="sectiuneaParola" class="panel-collapse collapse" role="tabpanel"
                                                 aria-labelledby="headingPreferinte" aria-expanded="false">
                                                <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group mb-30"><label>Schimbă parola
                                                                    ...
                                                                    <input maxlength="12" placeholder="Seteaza parola"
                                            ...
                                            <div class="panel-heading" role="tab" id="headingPreferinte">
                                                <h6 class="panel-title">
                                                    <a class="collapsed" role="button" data-toggle="collapse"
                                                       ...
                                                       aria-expanded="false" aria-controls="sectiuneaPreferinte">Setări
                                                        notificări</a>
                                                </h6>
                                            </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="checkbox tab-content">
                                                                    <label><input type="checkbox" value=""
                                                                                  name="promotii" <?php echo($row['promotions'] == 1 ? "checked" : ""); ?>>
                                                                        Discounturi și promoții Academia Testării
                                                                    </label>
                                                                </div>
                                                                <div class="checkbox tab-content">
                                                                    <label><input type="checkbox" value=""
                                                                                  name="newsletter" <?php echo($row['newsletter'] == 1 ? "checked" : ""); ?>>
                                                                        Newsletter Academia Testării </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group mb-0 mt-0">
