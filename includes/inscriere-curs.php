		...
		if ( $botcheck == '' ) {
			...
			if (mysqli_num_rows($query_select)==0) {
				...
				if ( $query=(mysqli_query($link,$sql)) ) {
					...
					<p>Pentru a intra în contul tău de pe platforma Academia Testării trebuie mai întâi să activezi contul dând clik pe linkul de mai jos:<br><br><a href=\"/confirma.php?cheie=$cod_confirmare\">Confirmă înregistrarea</a><br><br>Am setat o parola temporara pentru tine: <strong>".$parola."</strong>. Poti schimba parola imediat dupa ce activezi contul.</p>
